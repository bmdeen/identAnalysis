function varargout=identTPSigStarBigPlot(groups,stats,nosort)
    ...
    %
    % Edited by Ben Deen, 03/2022 (identSigStarBigPlot):
    % - Increased defaultFontSize constant
    %
    % Edited by Ben Deen, 03/2022 (identTPSigStarBigPlot):
    % - Changed lowest p-value cutoff to P<.05
